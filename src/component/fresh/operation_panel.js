            ...
            <div className="operation_panel">
                <div className="operation_panel_row">
                    ...
                    <div className="operation_panel_item" onClick={this.mode_panel}>
                        <ControlItem src="fa fa-tags" text="模式" open={this.props.online}/>
                ...
                <div className="operation_panel_row">
                    ...
                    <div className="operation_panel_item" onClick={this.heat_panel}>
                        <ControlItem src={this.props.heat==0?"fa fa-thermometer-empty":'fa fa-thermometer-4'} text="辅热" open={this.props.heat!=0}/>
